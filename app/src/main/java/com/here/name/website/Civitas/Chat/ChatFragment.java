...
public class ChatFragment extends Fragment {
  /*  private static final String TAG = "FeelingsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mContext=getContext();
        mConvList=(RecyclerView) mMainView.findViewById(R.id.convView);
    ...
    public static class ConvViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setMessage(String message, boolean isSeen){
            ...
            TextView userStatusView = (TextView) mView.findViewById(R.id.username);
        ...
        public void setUserImage(String thumb_image, Context ctx){
            ...
            CircularImageView userImageView = (CircularImageView) mView.findViewById(R.id.image_heart_outline);
            Picasso.with(ctx).load(thumb_image).placeholder(R.drawable.ic_username).into(userImageView);

        }

        public void setUserOnline(String online_status) {

            ImageView userOnlineView = (ImageView) mView.findViewById(R.id.image_heart_fill);
